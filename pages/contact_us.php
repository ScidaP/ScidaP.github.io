...
<?php
	if(isset($_POST['email'])){
		...
		$reply_customer_email = $_POST['email'];
		$customer_name = $_POST['name'];
		$error_code = "ECpdc725ss8n";
		$html_email = $_POST['message'] . "<br> Dirección email del cliente: " . $reply_customer_email . "<br> Nombre: " . $customer_name;
		...
		if($mailer_status == "success"){
			$message = "<div class='contact-form-success alert alert-success mt-4'><strong>Mensaje enviado con éxito!</strong> Te responderemos en menos de 24hs.</div>";
		}else if($mailer_status == "error"){
			$message = "<div class='contact-form-success alert alert-danger mt-4'><strong>Error al enviar el mensaje.</strong> Contáctanos en $company_email</div> ";
		}
